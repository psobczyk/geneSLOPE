...
```{r}
main(phenotypeFile = pheFile, snpFiles = snpsFile, pValMax = 0.05, 
     rho = 0.5, fdr = 0.1, verbose = FALSE)
```
...
You can call clumped SLOPE directly. Clumping procedure will be done automatically. 
